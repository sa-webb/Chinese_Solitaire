...
public class Solitaire
{
	...
	public static final Point PLAY_POS = new Point(DECK_POS.x, FINAL_POS.y + Card.CARD_HEIGHT + 40);
	...
	private static final JFrame frame = new JFrame("Chinese Solitaire");
	...
	private static class ShowRulesListener implements ActionListener
	{
		...
		public void actionPerformed(ActionEvent e)
		{
			...
			/// Need to change the rules with an appropriate source 
			
			String rulesText = "<b>Chinese Solitaire Rules</b>"
	...
	private static void playNewGame()
	{
		...
		Card a1 = deck.pop().setFaceup();
		Card a2 = deck.pop().setFaceup();
		Card a3 = deck.pop().setFaceup();
		Card a4 = deck.pop().setFaceup();
		Card a5 = deck.pop().setFaceup();
		Card a6 = deck.pop().setFaceup();
		Card a7 = deck.pop().setFaceup();
		
		Card b1 = deck.pop().setFaceup();
		Card b2 = deck.pop().setFaceup();
		Card b3 = deck.pop().setFaceup();
		Card b4 = deck.pop().setFaceup();
		Card b5 = deck.pop().setFaceup();
		Card b6 = deck.pop().setFaceup();
		Card b7 = deck.pop().setFaceup();
		
		Card c1 = deck.pop().setFaceup();
		Card c2 = deck.pop().setFaceup();
		Card c3 = deck.pop().setFaceup();
		Card c4 = deck.pop().setFaceup();
		Card c5 = deck.pop().setFaceup();
		Card c6 = deck.pop().setFaceup();
		Card c7 = deck.pop().setFaceup();
		
		Card d1 = deck.pop().setFaceup();
		Card d2 = deck.pop().setFaceup();
		Card d3 = deck.pop().setFaceup();
		Card d4 = deck.pop().setFaceup();
		Card d5 = deck.pop().setFacedown();
		Card d6 = deck.pop().setFacedown();
		Card d7 = deck.pop().setFacedown();
		
		Card e1 = deck.pop().setFaceup();
		Card e2 = deck.pop().setFaceup();
		Card e3 = deck.pop().setFaceup();
		Card e4 = deck.pop().setFacedown();
		Card e5 = deck.pop().setFacedown();
		Card e6 = deck.pop().setFacedown();
		Card e7 = deck.pop().setFacedown();
		
		Card f1 = deck.pop().setFaceup();
		Card f2 = deck.pop().setFaceup();
		Card f3 = deck.pop().setFacedown();
		Card f4 = deck.pop().setFacedown();
		Card f5 = deck.pop().setFacedown();
		Card f6 = deck.pop().setFacedown();
		Card f7 = deck.pop().setFacedown();
		
		
		Card g1 = deck.pop().setFaceup();
		Card g2 = deck.pop().setFacedown();
		Card g3 = deck.pop().setFacedown();
		Card g4 = deck.pop().setFacedown();
		Card g5 = deck.pop().setFacedown();
		Card g6 = deck.pop().setFacedown();
		Card g7 = deck.pop().setFacedown();
		
		
		playCardStack[0].putFirst(a1);
		playCardStack[0].push(a2);
		playCardStack[0].push(a3);
		playCardStack[0].push(a4);
		playCardStack[0].push(a5);
		playCardStack[0].push(a6);
		playCardStack[0].push(a7);
		
		playCardStack[1].putFirst(b1);
		playCardStack[1].push(b2);
		playCardStack[1].push(b3);
		playCardStack[1].push(b4);
		playCardStack[1].push(b5);
		playCardStack[1].push(b6);
		playCardStack[1].push(b7);
		
		playCardStack[2].putFirst(c1);
		playCardStack[2].push(c2);
		playCardStack[2].push(c3);
		playCardStack[2].push(c4);
		playCardStack[2].push(c5);
		playCardStack[2].push(c6);
		playCardStack[2].push(c7);
		
		
		playCardStack[3].putFirst(d1);
		playCardStack[3].push(d2);
		playCardStack[3].push(d3);
		playCardStack[3].push(d4);
		playCardStack[3].push(d5);
		playCardStack[3].push(d6);
		playCardStack[3].push(d7);
		
		playCardStack[4].putFirst(e1);
		playCardStack[4].push(e2);
		playCardStack[4].push(e3);
		playCardStack[4].push(e4);
		playCardStack[4].push(e5);
		playCardStack[4].push(e6);
		playCardStack[4].push(e7);
		
		
		playCardStack[5].putFirst(f1);
		playCardStack[5].push(f2);
		playCardStack[5].push(f3);
		playCardStack[5].push(f4);
		playCardStack[5].push(f5);
		playCardStack[5].push(f6);
		playCardStack[5].push(f7);
		
		
		playCardStack[6].putFirst(g1);
		playCardStack[6].push(g2);
		playCardStack[6].push(g3);
		playCardStack[6].push(g4);
		playCardStack[6].push(g5);
		playCardStack[6].push(g6);
		playCardStack[6].push(g7);
...
//			Card a4 = deck.pop().setFaceup();
//
//			playCardStack[x].putFirst(a1);
//			playCardStack[x].push(a2);
//			playCardStack[x].push(a3);
//			playCardStack[x].push(a4);
//
//			// Nested
//			for (int y = x + 1; y < NUM_PLAY_DECKS; y++)
//			{
//				playCardStack[y].putFirst(a1 = deck.pop());
//				//playCardStack[y].push(a2);
//
//			}
//		}
		...
		gameTitle.setText("<b>Chinese Solitaire </b> <br> Team 1 <br>CPSC 4900 <br> Fall 2018");
